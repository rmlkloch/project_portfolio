...
const CSS = `
  ...
  *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  /* Reduced font-size globally from 16px to 15px to scale everything down seamlessly */
  html { scroll-behavior: smooth; font-size: 15px; width: 100%; max-width: 100%; }
  body { 
  ...
  .container {
    width: 100%;
    max-width: 1024px; /* Pulled in from 1100px to avoid wide stretching on PC */
    margin: 0 auto;
    padding: 0 1.5rem;
  }
  .section {
